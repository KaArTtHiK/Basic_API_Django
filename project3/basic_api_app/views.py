...
from basic_api_app.models import Article
from basic_api_app.serializers import ArticleSerializer
...
def index(request):
    return HttpResponse("Basic Api Application by karthik")
...
def detail_article(request, pk):
    try:
        ...
        return HttpResponse(status = status.status.HTTP_404_NOT_FOUND)
